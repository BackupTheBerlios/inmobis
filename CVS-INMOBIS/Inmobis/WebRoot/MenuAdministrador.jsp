...
<%String tituloPag = "INMOBIS Real Estate - Menu Administrador";%>
...
<%String subtitulo="P&aacute;gina Principal del Administrador";%>
...
<%@include file="menu_izdo.jsp" %>
              ...
              <div id="content"> 
                <div class="feature"> 
                  <h3>&iquest;Qu&eacute; <img src="images/inmobis1.jpg" title="INMOBIS" alt="INMOBIS" width="333"></h3><br><br>
